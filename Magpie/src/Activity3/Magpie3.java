...
public class Magpie3 {
    ...
    public String getResponse(String statement) {
        ...
        }else if (findKeyword(statement,"vegetable")>= 0
                || findKeyword(statement, "cucumber")>=0
                || findKeyword(statement, "tomatoe")>=0
                || findKeyword(statement, "broccoli")>=0
                || findKeyword(statement, "corn")>= 0
                || findKeyword(statement, "carrot")>=0){
            response = "Vegetables are good for you.";
        }else if (findKeyword(statement, "fruit")>=0
                || findKeyword(statement, "apple")>=0
                || findKeyword(statement, "berry")>=0
                || findKeyword(statement, "blueberry")>=0
                || findKeyword(statement, "blackberry")>=0
                || findKeyword(statement, "strawberry")>=0
                || findKeyword(statement, "pineapple")>=0
                || findKeyword(statement, "mango")>=0
                || findKeyword(statement, "kiwi")>=0
                || findKeyword(statement, "cherry")>=0){
            response = "Fruits are better than vegetables.";
